                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ isset($data['item']) ? route('writers.update',$data['item']->id) : route('writers.store'); }}" method="POST" enctype="multipart/form-data">
                                @csrf()
                                @if(isset($data['item']))
                                    @method('put')
                                @endif
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <input value="{{ isset($data['item']) ? $data['item']->WriterName : null }}" type="text" class="form-control" name="WriterName" placeholder="Writer Name" required>
                                        </div>
                                        <div class="form-group col-sm-3 col-md-3 col-lg-3">
                                            <label>Contact</label>
                                        ...
                                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <label class="col-md-3" style="cursor:pointer">
                                                @php
                                                    $imgUrl = asset('public/uploads/writers/placeholder.png');
                                                    if((isset($data['item']) && $data['item']->Image!=null)) $imgUrl = asset('public/uploads/writers/'.$data['item']->Image) 
                                                @endphp
