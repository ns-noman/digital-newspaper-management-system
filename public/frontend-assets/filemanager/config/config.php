...
$base_url="http://www.bangladesherkhabor.net/resources";
$upload_dir = '/uploaded/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../resources/uploaded/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../resources/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','psd','ppt','pptx','ai'); //Files
