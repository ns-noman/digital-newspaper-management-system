...
class ElectionResults extends Model
{
    ...
    public function figuresShow(){
        return $this->hasMany('App\Models\ElectionResultFigures', 'election_result_id', 'id')->where('status', 1)->where('display_result', 1)->orderBy('order_id', 'desc');
    }
