...
@push('meta-tag')
<title>{!! !empty($pageInfo) ? $pageInfo->meta_title : 'Privacy Policy - '.$settingsInfo->title !!}</title>
<meta property="og:title" content="{!! !empty($pageInfo) ? $pageInfo->meta_title : 'Privacy Policy - '.$settingsInfo->title !!}" />
<meta name="twitter:title" content="{!! !empty($pageInfo) ? $pageInfo->meta_title : 'Privacy Policy - '.$settingsInfo->title !!}" />
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-12 marginB20 hidden-xs">
				<div class="borderC1B1">
					<h1 class="desktopCategoryTitle"><strong><span class="leftSpan"></span> Privacy Policy</strong></h1>
				</div>
			</div>
			<div class="col-sm-12 col-md-12 paddingLR20 marginB15 visible-xs paddingT10 marginT10">
				<h1 class="sectionTitle displayInline border0 margin0 marginB0"><strong><span class="leftSpan"></span> Privacy Policy</strong></h1>
			</div>

			<div class="col-sm-9 col-md-9">
				<div class="marginB20 textBody">
					{!! $settingsInfo->privacy ? $settingsInfo->privacy : '' !!}
				</div>
			</div>
