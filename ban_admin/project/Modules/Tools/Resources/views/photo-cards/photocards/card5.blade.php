...
<div class="cartBody" id="cartBody{!! $uniqueId !!}">
	<img src="{{asset('assets/images/photoframes/cardframe-5.png')}}" class="frameImg">
	<img src="{{$b64image}}" id="photoCartThumbnail" class="newsImg">
	<span style="position: absolute;z-index: 999;left: 0;border-radius: 5px;background-color: white;padding: 3px;margin-top: 530px;margin-left: 357px">
		<img src="{!! asset('assets/images/photoframes/logo-white.png') !!}" style="background-color: #001b3d;width: 280px;padding: 10px;border-radius: 10px;">
	</span>
	<div id="draggable" class="titleMainDiv">
		...
		<p style="position: absolute;bottom: 0;margin-bottom: -49px;width: 945px;text-align: left;z-index: 999;color: white;margin-left: 25px;margin-right: 25px;">
