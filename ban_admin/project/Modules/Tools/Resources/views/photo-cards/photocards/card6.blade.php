...
<style type="text/css">
	...
	#photoCardModal .cartBody{
		width: 995px;margin: 0 auto;position: relative;background-color: #012b0d;
	}
...
<div class="cartBody" id="cartBody{!! $uniqueId !!}">
	...
	<div style="position: absolute;top: 0;width: 100%;margin-top: 470px;height: 100px;z-index: 99;">
		<p style="border-bottom: 5px solid white;position: absolute;width: 100%;bottom: 0;"><span style="border-radius: 5px;background-color: white;padding: 3px;position: absolute;margin-left: -160px;margin-top: -25px;"><img src="{!! asset('assets/images/photoframes/logo-white.png') !!}" style="width: 280px;background-color: #012b0d;padding: 10px;border-radius: 10px;"></span></p>
	</div>
	<div class="titleMainDiv">
		...
		<p style="position: absolute;bottom: 0;margin-bottom: 15px;width: 945px;text-align: left;z-index: 999;color: white;margin-left: 25px;margin-right: 25px;">
			<span class="dateClass" style="font-size: 2.7rem;padding: 4px 15px;border-top-left-radius: 20px;border-top-right-radius: 20px;width: 29%;display: inline-block;text-align: left;">{!! \App\Http\Controllers\CommonController::GetBangla(date('d M Y', strtotime($newsInfo->created_at))) !!}</span>
			<span class="dateClass" style="font-size: 2.7rem;padding: 4px 15px;border-top-left-radius: 20px;border-top-right-radius: 20px;width: 42%;display: inline-block;text-align: center;"><i class="fa fa-globe"></i> {!! str_replace(['https://', '/', 'www.'], '', $settingsInfo->domain) !!}</span>
			<span class="dateClass" style="font-size: 2.7rem;padding: 4px 15px;border-top-left-radius: 20px;border-top-right-radius: 20px;width: 28%;display: inline-block;text-align: right;">বিস্তারিত কমেন্টে>></span>
		</p>
	</div>
