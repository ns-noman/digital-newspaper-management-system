...
<div class="cartBody" id="cartBody{!! $uniqueId !!}">
	<img src="{{asset('assets/images/photoframes/cardframe-3.png')}}" class="frameImg">
	<img src="{{$b64image}}" id="photoCartThumbnail" class="newsImg">
	<span style="position: absolute;z-index: 999;left: 0;border-radius: 5px;background-color: white;padding: 3px;margin-top: 533px;margin-left: 357px">
		<img src="{!! asset('assets/images/photoframes/logo-white.png') !!}" style="background-color: #600b89;width: 280px;padding: 10px;border-radius: 10px;">
	</span>
