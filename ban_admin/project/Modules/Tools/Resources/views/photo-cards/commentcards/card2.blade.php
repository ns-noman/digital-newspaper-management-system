...
<style type="text/css">
	...
	#generateCardModal .cartBody .shoulderClass{
		color: white;font-size: 4rem;line-height: 6rem;font-weight: bold;margin-bottom: 0px;text-align: left;
	}
	#generateCardModal .cartBody .hangerClass{
		color: white;font-size: 4rem;line-height: 6rem;margin-bottom: 0px;text-align: left;
	}
	#generateCardModal .cartBody .headlineClass{
		margin-bottom: 0px;color: white;font-weight: bold;font-size: 5rem;line-height: 7rem;
	}
...
<div class="cartBody" id="cartBody1" style="overflow: hidden;">
	<div class="bgColorStory" style="background-image: url({!! asset('assets/images/photoframes/commentcardlayout-2.jpg') !!});">

		<p style="text-align: center;width: 314px;margin-top: 100px;position: absolute;top: 0;right: 0;margin-right: 100px;"><img src="{!! asset('assets/images/photoframes/logo-white.png') !!}" style="width: 280px;"></p>

		<div id="draggable" style="width: 450px;margin-top: 160px;position: absolute;cursor: all-scroll;left: 0;margin-left: 120px;text-align: left;">
			<div class="textDiv">
				<p class="headlineClass" style="color: white;font-weight: bold;text-align: left;"></p>
			</div>
		</div>

		<div id="draggable2" style="min-width: 460px;position: absolute;bottom: 0;left: 0;margin-left: 120px;cursor: all-scroll;margin-bottom: 110px;">
			<div style="margin-top: 30px;border-bottom: 5px solid #ffa51f;">
				<p class="shoulderClass"></p>
				<p class="hangerClass"></p>
			</div>
		</div>
		<div style="width: 400px;position: absolute;bottom: 0;right: 0;cursor: all-scroll;">
			<img src="" id="outputImage" class="" style="z-index: 9;width: 100%;border: 8px solid #ffffff;">
		</div>

		<p style="position: absolute;bottom: 0;margin-left: 120px;font-size: 2.5rem;color: #e9e9e9;"><i class="fa fa-globe"></i> {!! str_replace(['https://', '/', 'www.'], '', $settingsInfo->domain) !!}</p>
	</div>
</div>
