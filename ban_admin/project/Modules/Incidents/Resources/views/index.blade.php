...
<section class="vbox">
	<section class="scrollable padder">
		...
		<section class="panel panel-default">
			<header class="panel-heading font-bold">Incidents
				<a href="javascript::void(0)" data-toggle="modal" data-target="#createModal" class="btn btn-success btn-xs pull-right"> <i class="fa fa-plus-circle"></i> New Incident</a>
			...
			<form method="post" action="{{route('Incidents Bulk Update')}}">
				{{csrf_field()}}
						...
						<tbody class="dragAndDrop">
							...
							<tr>
								...
								<td>
									...
									<a href="{{route('Incidents Delete', $list->id)}}" class="btn btn-danger btn-xs delete" onclick="return confirm('Are you sure you want to  delete?');"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							@endforeach
							@else
		...
		<div class="content">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" class="form-horizontal" method="post" action="{{route('Incidents Store')}} " enctype="multipart/form-data">
						{{csrf_field()}}
		...
		<div class="content">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					{{route('Incidents Update')}}" enctype="multipart/form-data">
					{{csrf_field()}}
