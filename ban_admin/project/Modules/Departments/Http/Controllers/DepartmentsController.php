...
class DepartmentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['lists'] = Departments::whereIn('status', [1,2])
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('Departments')->withErrors($validator)->withInput()->with('error_message','Form validation failed!.');
        }

        try{
            DB::beginTransaction();

            $dataInfo = new Departments;
            ...
            return redirect()->route('Departments')->with('success_message', 'Department has been created successfully!.');

        }catch(Exception $e){
          DB::rollback();
          return redirect()->route('Departments')->with('error_message', 'Failed to create Department!.');
      }
  }
    ...
    public function update(Request $request)
    {
        ...
        try{
            ...
            return redirect()->route('Departments')->with('success_message', 'Department has been updated successfully!.');

        }catch(Exception $e){
          DB::rollback();
          return redirect()->route('Departments')->with('error_message', 'Failed to update Department!.');
      }
  }
    ...
    public function orderID(){
        $orderIDInfo = Departments::orderBy('order_id', 'desc')->first();
