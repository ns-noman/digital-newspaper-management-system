@extends('layouts.app')
@section('title', 'Marketing Companies')
...
<section class="vbox">
	<section class="scrollable padder">
		...
		<section class="panel panel-default">
			<header class="panel-heading font-bold">Marketing Companies
				<a href="javascript::void(0)" data-toggle="modal" data-target="#createModal" class="btn btn-success btn-xs pull-right"> <i class="fa fa-plus-circle"></i> New Company</a>
			...
			<form method="post" action="{{route('MarketingCompanies Bulk Update')}}">
				{{csrf_field()}}
						...
						<tbody class="dragAndDrop">
							...
							<tr>
								...
								<td>
									...
									<a target="_blank" style="color: #337ab7 !important;" href="{{$list->website}}">{!! $list->title !!}</a>
									@else
									{!! $list->title !!}
									@endif
								</td>
								...
								<td>
									<button type="button" class="btn btn-primary btn-xs editModal" data-toggle="modal" data-target="#editModal" data-id="{{$list->id}}" data-title="{{$list->title}}" data-website="{{$list->website}}" data-contact="{{$list->contact}}" data-email="{{$list->email}}" data-status="{{$list->status}}"><i class="fa fa-edit" title="Edit"></i></button>
									<a href="{{route('MarketingCompanies Delete', $list->id)}}" class="btn btn-danger btn-xs delete" onclick="return confirm('Are you sure you want to  delete?');"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							@endforeach
							@else
		...
		<div class="content">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" class="form-horizontal" method="post" action="{{route('MarketingCompanies Store')}} " enctype="multipart/form-data">
						{{csrf_field()}}
		...
		<div class="content">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					{{route('MarketingCompanies Update')}}" enctype="multipart/form-data">
					{{csrf_field()}}
