...
function ConvertFromTextArea(text) {
    // var str = document.getElementById(idcvt).value;
    // str = ConvertToUnicode("bijoy", str);
    // Insert(document.getElementById(idcvt+"u"), str);

    // var text = $('.'+convertToClass).val();
    // text = ConvertToUnicode("bijoy", text);
    // $('.'+convertToClass).val(text);

    var newtext = ConvertToUnicode("bijoy", text);
    return newtext;
}
