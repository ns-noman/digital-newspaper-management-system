...
ctx.stroke();ctx.lineWidth=0;ctx.lineTo(points[plength-1][0],height);ctx.lineTo(points[0][0],height);ctx.closePath();if(fill!==!1){ctx.fillStyle=c;ctx.fill()}}
...
function drawSpline(plot,ctx,series){if(series.splines.show!==!0){return}
...
$.plot.plugins.push({init:function(plot){plot.hooks.drawSeries.push(drawSpline)},options:{series:{splines:{show:!1,lineWidth:2,tension:0.5,fill:!1}}},name:'spline',version:'0.8.2'})})(jQuery)